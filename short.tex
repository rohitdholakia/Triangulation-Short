...
\begin{itemize}\addtolength{\itemsep}{-0.4\baselineskip}
	...
	\item When combining with the direct system, do we use uniform linear interpolation or alternative decoding paths? 
...
\section{Models}
\label{sec:models}
	In this section, we discuss two methods for computing phrase scores and two methods for computing lexical scores. We also propose a new iterative method to combine the direct and triangulated systems by using grid search over model weights. To penalize phrase pairs with little alignment between them, we also discuss a method from~\cite{Ahmed:13}.  
\begin{comment}
