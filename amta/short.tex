...
\alert{I think we should say that although we did it for low-resource, these findings stand anyway}
...
This paper provides the following contributions which are useful when building an SMT system using triangulation: 
